...
import { firestoreService, type User, type QRCode } from "@/firebase/firestore";
    ...
    useEffect(() => {
        const loadDashboardData = async () => {
            ...
            try {
                ...
                const [users, qrCodes, entryPoints] = await Promise.all([
                    firestoreService.users.getByCompound(selectedCompound.id!),
                    firestoreService.qrCodes.getByCompound(
                        selectedCompound.id!
                    ),
                    firestoreService.entryPoints.getByCompound(
                        selectedCompound.id!
                    ),
                ]);
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white">
                ...
                <p className="text-blue-100">
                    Managing <strong>{selectedCompound?.name}</strong> -{" "}
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Latest property owner registrations
                        </CardDescription>
                    </div>
